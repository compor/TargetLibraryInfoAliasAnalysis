# TargetLibraryInfoAliasAnalysis - A pass for LLVM opt
...
`opt -load [path to plugin]/libLLVMTargetLibraryInfoAliasAnalysisPass.so -tli-aa foo.bc -o foo.out.bc`

### Using clang

`clang -Xclang -load -Xclang [path to plugin]/libLLVMTargetLibraryInfoAliasAnalysisPass.so foo.c -o foo`
